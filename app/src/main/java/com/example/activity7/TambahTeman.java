...
public class TambahTeman extends AppCompatActivity {
    private EditText editNama,editTelfon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTelfon = findViewById(R.id.edTelpon);
